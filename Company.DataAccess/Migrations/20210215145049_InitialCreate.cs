        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionPaymentAmount = table.Column<float>(type: "real", nullable: false),
                    CollectionPaymentDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Corporations", x => x.CompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectStarTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectFinishTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectFee = table.Column<float>(type: "real", nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
